...
@include('backend.sidebar')
            ...
            <aside class="right-side">
                ...
                <section class="content">
                 ...
                 {!! Form::open(array('action' => 'AdsController@adsupdate','enctype' => 'multipart/form-data')) !!}
                ...
                <div class="form-group">
                  ...
                  <img width="100px;" src="uploads/{{$reklam->ads1}}">
                </div>  
                ...
                <div class="form-group">
                  ...
                  <img width="100px;" src="uploads/{{$reklam->ads2}}">
                </div> 
                ...
                <div class="form-group">
                  ...
                  <img width="100px;" src="uploads/{{$reklam->ads3}}">
                </div>   
