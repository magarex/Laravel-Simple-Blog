...
<html>
    <head>
        ...
        {{Html::script('https://cdnjs.cloudflare.com/ajax/libs/sweetalert/1.1.3/sweetalert-dev.js')}}
        ...
        <!-- Morris chart -->
        {{Html::style('backend/css/morris/morris.css')}}

        <!-- jvectormap -->
        {{Html::style('backend/css/jvectormap/jquery-jvectormap-1.2.2.css')}}

        <!-- fullCalendar -->
        {{Html::style('backend/css/fullcalendar/fullcalendar.css')}}

        <!-- Daterange picker -->
        {{Html::style('backend/css/daterangepicker/daterangepicker-bs3.css')}}
        <!-- bootstrap wysihtml5 - text editor -->
        {{Html::style('backend/css/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css')}}
        <!-- Theme style -->
        {{Html::style('backend/css/AdminLTE.css')}}
