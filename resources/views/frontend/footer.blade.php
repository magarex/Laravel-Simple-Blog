				...
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="footer_top_box">
							...
							<img width="100px" src="{{ URL::to('/') }}/uploads/{{ $listele->logo }}" alt="Footer Logo" />
									...
									<div class="footer_top_right">
										<div class="ftr_video">
											...
											<div class="results_video embed-responsive embed-responsive-16by9">
												<iframe width="854" height="480" src="{{$listele->dailyvideo}}" frameborder="0" allowfullscreen></iframe>
											</div>
										</div>
