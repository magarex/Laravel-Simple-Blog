					...
					<div class="fashion_area">
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								...
								<?php $__currentLoopData = $magazine; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $maga): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
											...
											<div class="fs_news_left ht_fs_news_left">
												<div class="single_fs_news_left_text">
													<div class="single_fs_news_img_h2">
														<img src="uploads/<?php echo e($maga->articlesimage); ?>" alt="" />
														<div class="br_cam">
															<a class="fa fa-camera" href=""></a>
														</div>
													</div>
													<h4><a href="content/<?php echo e($maga->id); ?>"><?php echo e($maga->articlesname); ?></a></h4>
													<p>
