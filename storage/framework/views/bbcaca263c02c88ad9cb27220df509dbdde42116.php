            ...
            <aside class="right-side">
                ...
                <section class="content">
                    ...
                    <div class="row">
                        ...
                        <?php echo Form::model($articles, ['method' => 'PATCH', 'files' => true, 'action' => ['ArticlesController@update', $articles->id]]); ?>


                        <div class="form-group">
                            <label>Makale Başlık Giriniz:</label>
                            <input type="text" class="form-control" name="articlesname" value="<?php echo e($articles->articlesname); ?>">
                        </div> 
                        ...
                        <textarea name="articlescontent" class="ckeditor"><?php echo e($articles->articlescontent); ?></textarea>
                        <script>
                        ...
                        <?php echo Form::close(); ?>
                           ...
                           <?php echo Form::model($articles, ['method' => 'DELETE','action' => ['ArticlesController@destroy', $articles->id]]); ?>
